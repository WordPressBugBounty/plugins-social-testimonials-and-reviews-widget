...
Select your favorite reviews in the dashboard at your Wordpress admin for display in the widgets. Get notified and do this in real-time via our app!
...
This is where Repuso come in. Repuso offers an easy, customizable way to ask video reviews from your clients. Clients will be able to record videos on any device (either desktop, tablet or mobile phone), upload an existing video or share a link to their YouTube / Vimeo video.
Then, you’ll be able to showcase them on your website in several ways that your visitors will love!

Some of the channels we support:
...
1. Floating widget
2. Grid widget
3. Inline slider widget
4. Photo slider widget
5. Badge widget
6. Flash widget
7. Masonry widget
8. Media Wall widget
...
= 4.97 =
Floating widget display settings fix

= 4.96 =
Action link fix

= 4.95 =
GlossGenius new channel
...
= 4.90 =
14 new review platforms (channels) supported
...
Own Live chat support for resellers / white label
...
= 4.60 =
Review export to designs for social platforms

= 4.53 =
Multi account fix

= 4.52 =
Fix New Relic conflict

= 4.51 =
WP 5.8

= 4.50 =
New widgets: List, Slider, Badge
...
= 4.43 =
Fix add_thickbox WP bug

= 4.42 =
Minor fix

= 4.41 =
Fixed conflict with One Click SSL plugin

= 4.40 =
New Realtor.com channel
New Media wall widget

= 4.36 =
Video guides
Alternative to elfsight, brightlocal, grade.us, endorsal, birdeye, nicejob

= 4.35 =
Update dismiss notice
...
= 3.2 =
New channels: Houzz, HomeAdvisor, Angie's List, BBB, OpenTable
...
= 3.0 =
Faster widgets with less footprint
Standalone tags for sub accounts
Anti review gating option
Custom rich snippet schema
More precise from date on reviews
Custom announcements in widgets
New tutorials
...
= 2.3 =
Added Zillow channel

= 2.2 =
Added Badge widget shortcode

= 2.1 =
Added Expedia channel

= 2.0 =
Added Floating badge widget

= 1.9 =
Added Booking.com and GetYourGuide channels

= 1.8 =
Notice fix

= 1.7 =
Added Vrbo / HomeAway channels

= 1.6 =
Added Airbnb and Healthgrades channels

= 1.5 =
Added Custom CSS for widgets feature

= 1.4 =
Added Yellow Pages channel

= 1.3 =
Added multi website support

= 1.2 =
Added photoset widget shortcode

= 1.1 =
Added inline widget shortcode.
...
We offer a free trial period, afterwards it'll require to select a paid plan: [Repuso plans](https://repuso.com/pricing/?utm_source=web&utm_medium=wordpress&utm_campaign=plugin "Repuso - Social proof testimonials")
